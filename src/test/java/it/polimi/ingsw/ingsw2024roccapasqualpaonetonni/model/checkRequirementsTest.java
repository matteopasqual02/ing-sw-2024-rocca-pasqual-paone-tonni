...
class checkRequirementsTest {
    ...
    @Test
    void checkRequirementsResourceCardTest() throws InvalidPlaceException, ConditionsNotMetException {
        ...
        int[] req = card_to_add1.checkRequirements(owner.getCountSeed());
        int[] trueReq={1,0};
        assertArrayEquals(trueReq,req);
